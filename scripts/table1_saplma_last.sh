#!/usr/bin/env bash
# Table 1: SAPLMA (last layer), Llama-3.1-8B
#
# Same as table1_saplma_middle.sh with probe_feature_extractor_setting=hs
# (last hidden layer instead of middle).
#
...
COMMON=(
  ...
  --probe_feature_extractor_setting hs
