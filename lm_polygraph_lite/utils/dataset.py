...
class RawTextDataset:
    ...
    def from_csv(
        ...
        **kwargs,
        ...
        return RawTextDataset(x, y, batch_size)
        ...
        **kwargs,
        ...
        Parameters:
            ...
            size (Optional[int]): size to subsample dataset to. If None, the full dataset split will be taken.
                Default: None.
        """
        dataset_name, dataset = RawTextDataset.load_hf_dataset(dataset_path, split, **kwargs)
        few_shot_dataset = None
        if n_shot > 0:
            _, few_shot_dataset = RawTextDataset.load_hf_dataset(
    ...
    def load(path_or_path_and_files: Union[str, List[str]], *args, **kwargs):
        ...
        if isinstance(path_or_path_and_files, str) and os.path.isfile(
            ...
            return RawTextDataset.from_csv(path_or_path_and_files, *args, **kwargs)
        return RawTextDataset.from_datasets(path_or_path_and_files, *args, **kwargs)
