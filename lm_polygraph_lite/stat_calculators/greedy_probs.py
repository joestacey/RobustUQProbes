...
class GreedyProbsCalculator(StatCalculator):
    """
    For Whitebox model (lm_polygraph_lite.utils.model.WhiteboxModel), at input texts batch calculates:
    * generation texts
    ...
    def __call__(
        ...
        Returns:
            Dict[str, np.ndarray]: dictionary with the following items:
                ...
                - 'attentions_all' (List[List[np.array]]): attention maps at each token, if applicable to the model,
